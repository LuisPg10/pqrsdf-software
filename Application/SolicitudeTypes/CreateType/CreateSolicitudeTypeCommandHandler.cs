...
public class CreateSolicitudeTypeCommandHandler(ISolicitudeTypeRepository solicitudeTypeRepository, IUnitOfWork unitOfWork)
    : IRequestHandler<CreateTypeSolicitudeCommandDto, ErrorOr<Unit>>
{

    public async Task<ErrorOr<Unit>> Handle(CreateTypeSolicitudeCommandDto request, CancellationToken cancellationToken)
    {
